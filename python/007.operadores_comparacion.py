...
## RESULTADO DE TODOS LOS OPERADORES DE COMPARACIÓN SERÁ TRUE O FALSE
# Igual ==
...
# Mayor o igual: num1 >= num2 (Greater or Equals GTE)
...
# Menor o igual que: num1 <= num2 (Greater than or equeals LTE)
